...
gst
obj = MyClass.new
p obj.public_method    # "MyClass#public_method"
p obj.public_send(:private_methods_1)
p obj.public_call_private_without_self # "MyClass#private_method_1"
p obj.public_call_private  # 不能在前面加 self. 字样（只能隐式指定 self）
